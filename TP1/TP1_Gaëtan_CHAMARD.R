...
# $net_after_tax
# [1] 1600.4
print(brutToNet3(2000, "non-cadre"))
# $net_before_tax
# [1] 1760
# 
# $net_after_tax
# [1] 1638
print(brutToNet3(2000, "cadre", 0.1, 75))
# $net_before_tax
# [1] 1290
# 
# $net_after_tax
# [1] 1201
print(brutToNet3("2000", "cadre", 0.1, 75))
# [1] "ERROR: salary, rate and time must be numeric"
print(brutToNet3(2000, "employé", 0.1, 75))
# [1] "ERROR: contract unknown"
print(brutToNet3(2000, "cadre", 1.5, 75))
# [1] "ERROR: rate and time must be in range(0,100)"